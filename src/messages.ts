...
export const messagePairs: [string,string][] = [
  ...
  ['AppleArchive mit LZFSE: Teilarchive bis 1 GiB werden einzeln zurückgelesen und geprüft. Nur temporäre Prüfkopien werden danach gelöscht. Arbeitsbereich: 5 GiB auf der internen SSD.','AppleArchive with LZFSE: parts of up to 1 GiB are read back and verified individually. Only temporary verification copies are then deleted. Workspace: 5 GiB on the internal SSD.'],
